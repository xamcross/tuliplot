...
That's not embedded mail, and it isn't pretending to be. What you get instead is one predictable place to click from, sitting next to cells that do load live: a Trello board, a project tracker, whatever else you check in the same few minutes. Gmail and Calendar become two fixed spots in your daily lineup instead of two tabs buried among the rest.
