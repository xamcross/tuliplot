...
public class AuthController {
    ...
    public ResponseEntity<UserDto> register(@Valid @RequestBody RegisterRequest req,
        ...
        establishSession(new TulipUserDetails(user), request, response);
    ...
    void establishSession(TulipUserDetails principal, HttpServletRequest request, HttpServletResponse response) {
